...
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/develop/deve/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/develop/deve/node_modules/devalue/index.js';
import { renderToString } from 'file://C:/develop/deve/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file://C:/develop/deve/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/develop/deve/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/develop/deve/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/develop/deve/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/develop/deve/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/develop/deve/node_modules/scule/dist/index.mjs';
import { klona } from 'file://C:/develop/deve/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/develop/deve/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/develop/deve/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/develop/deve/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/develop/deve/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/develop/deve/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/develop/deve/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file://C:/develop/deve/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://C:/develop/deve/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/develop/deve/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/develop/deve/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\develop\\deve","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\develop\\deve\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\develop\\deve\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\develop\\deve\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\develop\\deve\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _5EfkbJsgzx = (function(nitro) {
...
const _lazy_SkWiTC = () => Promise.resolve().then(function () { return miaomiao$1; });
const _lazy_j3CR5k = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/miaomiao', handler: _lazy_SkWiTC, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_j3CR5k, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_j3CR5k, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/develop/deve/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/develop/deve/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
